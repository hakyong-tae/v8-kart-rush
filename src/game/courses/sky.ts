...
export const sky: CourseDef = {
  ...
  points: [
    ...
    [-220, -56], [-192, -60],                        // 남서 복귀 — 이음새 스무딩 (스폰존 r6→r17)
  ],
  ...
  jumpPads: [{ t: 0.486, len: 0.012, lane: 0, w: 0.4 }], // 동쪽 정점 빅점프
  pits: [],
  itemRows: [
  ...
  gimmicks: [
    ...
    // 진흙 평지 = 감속 구간 (대포를 안 타면 여기로 내려가 손해 — 왼쪽 가장자리에 좁은 틈)
    { type: 'mud', t0: 0.585, t1: 0.625, lane: -0.2, w: 0.8 },
    // 북서 구름다리 (주기적으로 걷힘)
