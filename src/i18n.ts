...
const DICT = {
  ...
  statHandling: { en: 'Handling', ko: '핸들' },
  statDrift: { en: 'Drift', ko: '드리프트' },
  statFormula: { en: 'Stats = kart + character (1-10, 6 = neutral)', ko: '스탯 = 카트 + 캐릭터 (1~10, 6=중립)' },
  ...
  modePick: { en: 'Mode', ko: '모드 선택' },
  lapToggle: { en: '⏱️ Lap Attack', ko: '⏱️ 랩타임 도전' },
  lapToggleSub: { en: '(1:1 vs #1 ghost)', ko: '(1:1 고스트)' },
  variantPick: { en: 'Format', ko: '방식' },
  variantSolo: { en: 'FFA', ko: '개인전' },
  variantSoloSub: { en: '(8 karts)', ko: '(8인)' },
  variantTeam: { en: 'Team', ko: '팀전' },
  variantTeamSub: { en: '(points)', ko: '(포인트제)' },
  speedToggle: { en: '⚡ Speed', ko: '⚡ 스피드전' },
  speedToggleSub: { en: '(no items)', ko: '(아이템 없음)' },
  ...
  retired: { en: 'RETIRED', ko: '리타이어' },
  retiredMsg: { en: 'Too slow — 0 points', ko: '제한시간 초과 — 0점' },
  finishRush: { en: 'FINISH!', ko: '들어와!' },
  awaitOthers: { en: 'Waiting for others…', ko: '다른 레이서 대기 중…' },
  ptsSuffix: { en: 'pt', ko: '점' },
  ...
  roomsTitle: { en: '⚔️ Multiplayer Rooms', ko: '⚔️ 멀티플레이 방' },
  quickJoin: { en: '⚡ Quick Join', ko: '⚡ 빠른 입장' },
  quickJoinSub: { en: 'Jump into any open room', ko: '열린 방에 바로 입장' },
  createRoomBtn: { en: '＋ Create Room', ko: '＋ 방 만들기' },
  refreshRooms: { en: '⟳ Refresh', ko: '⟳ 새로고침' },
  noRooms: { en: 'No open rooms yet — create one!', ko: '열린 방이 없습니다 — 방을 만들어 보세요!' },
  roomWaiting: { en: 'Waiting', ko: '대기중' },
  roomPlaying: { en: 'In race', ko: '게임중' },
  roomLocked: { en: '🔒 Locked', ko: '🔒 비번방' },
  passPrompt: { en: 'Enter room password', ko: '방 비밀번호를 입력하세요' },
  wrongPass: { en: 'Wrong password.', ko: '비밀번호가 틀렸습니다.' },
  createPanelTitle: { en: 'Create a room', ko: '방 만들기' },
  createCourse: { en: 'Course', ko: '코스' },
  createMode: { en: 'Mode', ko: '모드' },
  createPass: { en: 'Password (optional)', ko: '비밀번호 (선택)' },
  createConfirm: { en: 'Create & Enter', ko: '만들고 입장' },
  cancel: { en: 'Cancel', ko: '취소' },
  roomFull: { en: 'Full', ko: '가득참' },
  loadingRooms: { en: 'Loading rooms...', ko: '방 목록 불러오는 중...' },
